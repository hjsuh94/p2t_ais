...
"""Main Simulation class for onions.

The attributes and methods are quite straightforward, see minimal_example.py 
for basic usage.
"""
class OnionSim(pyglet.window.Window):
    def __init__(self):
